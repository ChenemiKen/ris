...
class PrimaryTermReportController extends Controller
{
    ...
    public function store(StorePrimaryTermReportRequest $request)
    {
        ...
        $request->validate([
            ...
            'subject.*.test_1' => ['nullable', 'string'],
            'subject.*.test_2' => ['nullable', 'string'],
            'subject.*.test_3' => ['nullable', 'string'],
            'subject.*.test_4' => ['nullable', 'string'],
            'subject.*.exam' => ['nullable', 'string'],
            'subject.*.mark' => ['nullable', 'string'],
            ...
            'sport_activities_1' => [ 'nullable','string'],
            'sport_activities_2' => [ 'nullable','string'],
            'sport_activities_3' => [ 'nullable','string'],
    ...
    public function update(UpdatePrimaryTermReportRequest $request, PrimaryTermReport $report)
    {
        ...
        $request->validate([
            ...
            'result.*.test_1' => ['nullable','string'],
            'result.*.test_2' => ['nullable','string'],
            'result.*.id' => ['nullable','integer', 'exists:primary_term_results,id'],
            'result.*.test_3' => ['nullable','string'],
            'result.*.test_4' => ['nullable','string'],
            'result.*.exam' => ['nullable','string'],
            'result.*.mark' => ['nullable','string'],
            'result.*.grade' => ['nullable','string', Rule::in(['A','B','C','D','E','F'])],
            'result.*.effort_grade' => ['nullable','string', Rule::in(['A','B','C','D','E','F'])],
            'result.*.comment' => ['nullable','string', Rule::in(['excellent','very_good','good','fair','poor','fail'])],
            'times_school_opened' => [ 'nullable','integer'],
            'times_present' => [ 'nullable','integer'],
            'times_punctual' => ['nullable','integer'],
            'sport_activities_1' => [ 'nullable','string'],
