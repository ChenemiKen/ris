                    ...
                    <div class="col-md-4">
                        <div class="deshboard_main_top_edit_area_single_item">
                            ...
                            <select name="class" class="form-control" id="class" required>
                                ...
                                <option value="Prim 1" {{ old('class',  $homework->class) == "Prim 1" ? "selected" : "" }}>Primary 1</option>
                                <option value="Prim 2" {{ old('class',  $homework->class) == "Prim 2" ? "selected" : "" }}>Primary 2</option>
                                <option value="Prim 3" {{ old('class',  $homework->class) == "Prim 3" ? "selected" : "" }}>Primary 3</option>
                                <option value="Prim 4" {{ old('class',  $homework->class) == "Prim 4" ? "selected" : "" }}>Primary 4</option>
                                <option value="Prim 5" {{ old('class',  $homework->class) == "Prim 5" ? "selected" : "" }}>Primary 5</option>
                                <option value="Prim 6" {{ old('class',  $homework->class) == "Prim 6" ? "selected" : "" }}>Primary 6</option>
