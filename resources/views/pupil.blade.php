                    ...
                    <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                                <div class="dropdown-list-content dropdown-list-message">
                                    <a href="#" class="dropdown-item">
                                        <span class="dropdown-item-avatar text-white"> <img alt="image" src="assets/img/profile.png" class="rounded-circle" /> </span>
                                    ...
                                    <a href="#" class="dropdown-item">
                                        <span class="dropdown-item-avatar text-white">
                                            <img alt="image" src="assets/img/profile.png" class="rounded-circle" />
                                        </span>
                                        <span class="dropdown-item-desc">
                        ...
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="mu_profile_items nav-link dropdown-toggle nav-link-lg nav-link-user">
                                ...
                                <span class="mu_profile_items_left"><img alt="image" src="assets/img/profile.png" class="user-img-radious-style" /></span>
                            </a>
                ...
                <div class="main-sidebar sidebar-style-2">
                    <aside id="sidebar-wrapper">
                        <div class="sidebar-brand">
                            <a href="index.html">
                                <span class="mini-logo"><img alt="img" src="assets/img/" class="header-logo" /></span> <span class="logo-name"><img src="assets/img/logo.png" /></span>
                            </a>
                        </div>
                            ...
                            <div class="deshboard_booking_main_content_area">
                                <div class="deshboard_booking_main_content_area_container">
                                    ...
                                    <div class="deshboard_filter_area">
                                        <h4></h4>
                                        <ul>
                                            <li><a href="#"><img src="assets/img/sort.svg" alt="photos">Sort</a></li>
                                            <li><a href="#"><img src="assets/img/filter.svg" alt="photos">Filter</a></li>
                                        </ul>
                                    </div>
                                     <!-- Header area End  -->
