...
@section('title', 'Add Beacon Term Report')
@section('page-heading', 'Add Beacon Term Report')
...
@section('page-content')
    <div class="deshboard_main_edit_create_page_area">
        ...
        @endif
        {{-- form --}}
        <form action="{{route('create-beacon-report')}}" method="POST">
            @csrf
