...
@section('title', 'Beacon Term Reports')
@section('page-heading', 'Beacon Term Reports')
        ...
        <div class="deshboard_booking_main_content_area_container">
            @can('is-staff')
                <div class="text-right">
                    <a href="{{route('add-beacon-report')}}" class="crate_btn_area">+ Add Term Report</a>
                </div>
            @endcan
            <!-- Header area start  -->
            <form action={{route('beacon-reports')}} name="filter-form" method="get">
                @csrf
                        ...
                        @foreach($reports as $report)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('view-beacon-report',$report->id)}}"><i class="fa-solid fa-eye fa-lg mr-4"></i></a>
                                    @can('is-staff')
                                        <a href="{{route('edit-beacon-report', $report->id)}}"><i class="fa-solid fa-pen-to-square fa-lg mr-4 blue"></i></a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('delete-beacon-report', $report->id)}}" method="post">
                                                        @csrf
            ...
            <div class="table_pagination_area">
                <div class="table_pagination_area_left">
                    <form action="{{route('beacon-reports')}}" method="get">
