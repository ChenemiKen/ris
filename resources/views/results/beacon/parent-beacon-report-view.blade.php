@extends('results.beacon.parent-view-base')
@section('title', 'View beacon report')
@section('page-heading', 'Beacon Term report')
...
@section('page-content') 
    <div class="deshboard_booking_main_content_area pt-0">
        ...
        <div class="row"><div class="col mt-3"><a href="{{route('download-beacon-report', $report->id)}}" class="btn btn-disable float-right">Download PDF</a></div></div>
    </div>
@endsection